...
set graphXmlPath=D:\CommandLine_SNAP\LAI_S2B_20m_S210.xml

:: second parameter is a path to a parameter file
set parameterFilePath=D:\CommandLine_SNAP\resample_20m.properties

:: use third parameter for path to source products
set sourceDirectory=D:\CommandLine_SNAP\S2\B\
...
set targetDirectory=D:\CommandLine_SNAP\S2B_20m_S210\
